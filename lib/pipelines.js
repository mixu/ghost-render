...
module.exports = function(theme, inPath, outPath) {
  ...
  return {
    ...
    post: pi.head([
      ...
      pi.forEach(function(obj) { console.log(colors.green('Write post:', obj.path)); }),
    ...
    page: pi.head([
      ...
      theme.stream('page'),
      pi.mapKey('path', function(path, entry, index) { return outPath + entry.relativeUrl; }),
      pi.forEach(function(obj) { console.log(colors.grey('Write page:', obj.path)); }),
      // { path: ... , contents: html } -> file
      stream.dest()
    ]),
    ...
    index: pi.head([
      ...
      pi.mapKey('path', function(path, entry, index) { return outPath + entry.relativeUrl; }),
      pi.forEach(function(obj) { console.log(colors.cyan('Write index:', obj.path)); }),
      // { path: ... , contents: html } -> file
      stream.dest()
    ]),
    ...
    authors: pi.head([
      ...
      pi.fork(
        ...
        pi.head([
          ...
          pi.mapKey('path', function(path, entry, index) { return outPath + entry.relativeUrl; }),
          pi.forEach(function(obj) { console.log(colors.yellow('Write author:', obj.path)); }),
          // { path: ... , contents: html } -> file
          stream.dest()
        ]),
        pi.head([
